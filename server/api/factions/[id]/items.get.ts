...
export default defineEventHandler((event) => {
  ...
  // Get Items linked to this Faction (bidirectional)
  // UNION: Items where Faction is 'from' (outgoing) OR Faction is 'to' (incoming)
  const items = db
  ...
  `,
    ...
    .all(factionId, itemType.id, factionId, itemType.id)
